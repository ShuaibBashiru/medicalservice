    ...
    <div class="p-2">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="text" v-model="persionalId" :disabled="isDisabled" maxlength="100" id="persionalId" class="form-control" required placeholder="ID">
                </div>
...
// },
    data (){
        ...
        othername: null,
        email: null,
        persionalId: 'P'+new Date().getMilliseconds()+''+new Date().getMonth()+''+new Date().getDay()+''+new Date().getFullYear(),
        phone: null,
        gender: null,
        age: null,
        countryCode: null,
